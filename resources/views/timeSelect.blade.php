<select id='{{ $timestamp_type }}Month' class='{{ $timestamp_type }}Timestamp' name="{{ $timestamp_type }}Month" >
...
<select id='{{ $timestamp_type }}Day' class='{{ $timestamp_type }}Timestamp' name="{{ $timestamp_type }}Day">
...
<select id='{{ $timestamp_type }}Year' class='{{ $timestamp_type }}Timestamp' name="{{ $timestamp_type }}Year">
...
<select id='{{ $timestamp_type }}Hour' class='{{ $timestamp_type }}Timestamp' name="{{ $timestamp_type }}Hour">
...
<select  id='{{ $timestamp_type }}Minute' class='{{ $timestamp_type }}Timestamp' name="{{ $timestamp_type }}Minute">
